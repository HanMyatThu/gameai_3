...
# RENDER_EVERY_N_EPISODES = 100  # <— new
...
# FPS = 60  # ensure you have an FPS defined for rendering
...
#     render = (ep % RENDER_EVERY_N_EPISODES == 0)
...
#         print(f"Ep {ep:4d} | Last Reward: {total_reward:6.2f} | "
#               f"Avg Reward (100): {avg_reward:6.2f} | Epsilon: {agent.epsilon:.3f}")
...
# plt.tight_layout()
# plt.savefig("ddqn_training_plots.png")
